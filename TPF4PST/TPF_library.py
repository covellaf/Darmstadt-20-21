#  created by F Covella - Dec 2020 and Jan 2021
from os.path import join
import sys
import re
import datetime
import INTXMM_library #simport *
...
# ------------------- Parameters methods ------------------- 
    ...
    def create_parameters_sublist(self):
        """
        if you wish to create each parameter individually 
        """
    ...
    def assign_param(self, lst_p):
        """
        if you wish to pass a list of parameter created somewhere else 
        """
